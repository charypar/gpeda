...
learning and sampling space to a neighborhood of the optimimum, which enables sampling in the situation when 
...
\begin{figure}
  ...
  \caption{
    Medians (of 15 trials) of distances to optimum ($f_{\Delta}$) reached using a number of function evaluations
