...
Luk\'{a}\v{s} Bajer \\
       ...
       \affaddr{118 00 Prague 1}\\
       \affaddr{and}\\
       \affaddr{Institute of Computer Science}\\
       \affaddr{Academy of Sciences}\\
...
% Gaussian process regression is a stochastic modeling meth\-od based on a multidimensional Gaussian distribution. 
...
% data and get a posterior distribution of functions which agree with our observations. 
...
\begin{figure}
  ...
  \caption{
    ...
    % reached using a number of function evaluations
...
\begin{enumerate}[itemsep=-4pt]
  ...
  \item Store the best $(\tilde{\xx}, \tilde{y}) \in \mathcal{S}_i : \tilde{y} \leq y_k \, \forall (\xx_k, y_k) \in \mathcal{S}_i$  % = \underset{y}{\min} \, \mathcal{S}_i$
...
\newblock {\em Scalable Optimization via Probabilistic Modeling}, volume~33 of
