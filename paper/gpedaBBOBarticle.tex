...
exploitation of the input space. A number of criteria were examined by Jones et al. [Jones 01], of which the Probability of Improvement (PoI) is of interest for this work.
...
In this paper, XYZ is benchmarekd on X functions and number of evaluations to reach a given target function value is
presented.

\section{Gaussian Process regression}

% Stochastic model, generalization of gaussian distribution
% a collection of random variables, any finite number of which have a joint Gaussian distribution. [Rasmussen]
% completely specified by mean and covariance functions
% f(x) ~ GP(m(x), k(x, x')
% using constant m and squared exponential cov (def)
% probabilty of improvement definition (Jones)
% sampled in the optimization
