...
MC_INCLUDE= -a exp/opt_mgso.m -a exp/opt_cmaes.m -a exp/util -a exp/vendor/bbob -a exp/vendor/cmaes -a src
OUT = $(FNAME)
SRC = exp/$(FNAME).m
OTHERS = exp/bbob_test_01.m exp/metacentrum_task_matlab.m src/gpeda.m
