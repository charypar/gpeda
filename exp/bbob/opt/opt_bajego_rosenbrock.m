function [xbest result] = opt_bajego_rosenbrock(FUN, DIM, ftarget, maxfunevals)
...
step2d_ftarget = @(run) bajegoStep2d(run, fgeneric('ftarget'));
...
[xbest run] = bajego(opts, @evalHandle, @doeRandom, ... % @sampleSlice, ...
              rescaleConds, restartConds, stopConds, step2d_ftarget);
